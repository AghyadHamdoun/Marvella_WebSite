...
class BodyLanguage extends StatefulWidget {
  const BodyLanguage({Key? key}) : super(key: key);

  @override
  State<BodyLanguage> createState() => _BodyLanguageState();
}

class _BodyLanguageState extends State<BodyLanguage> {
  @override
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      AppResponsive(
                          mobile: MobileBodyLanguageScreen(),
                          tablet: TabletBodyLanguageScreen(),
                          desktop: DesktopBodyLanguageScreen()),
                      EndWebSite()
                    ],
                  ),
                ),
  ...
  Container DesktopBodyLanguageScreen() => Container(
        color: ColorManger.white,
        child: Column(
          children: [
            Container(
  ...
  Container TabletBodyLanguageScreen() => Container(
        color: ColorManger.white,
        child: Column(
          children: [
            Container(
  ...
  Container MobileBodyLanguageScreen() => Container(
        color: ColorManger.white,
        child: Column(
          children: [
            Container(
