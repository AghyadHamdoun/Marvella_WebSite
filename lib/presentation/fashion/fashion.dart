...
class _FashionState extends State<Fashion> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      AppResponsive(
                          mobile: MobileFashionScreen(),
                          tablet: TabletFashionScreen(),
                          desktop: DesktopFashionScreen()),
                      EndWebSite()
                    ],
                  ),
                ),
  ...
  Container DesktopFashionScreen() => Container(
        color: ColorManger.white,
        child: Column(
          children: [
            Container(
  ...
  Container TabletFashionScreen() => Container(
        color: ColorManger.white,
        child: Column(
          children: [
            Container(
  ...
  Container MobileFashionScreen() => Container(
        color: ColorManger.white,
        child: Column(
          children: [
            Container(
