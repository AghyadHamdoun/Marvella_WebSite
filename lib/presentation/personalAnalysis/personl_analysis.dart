...
class PersonalAnalysis extends StatefulWidget {
  const PersonalAnalysis({Key? key}) : super(key: key);
...
class _PersonalAnalysisState extends State<PersonalAnalysis> {
  ...
  Widget build(BuildContext context) {
    ...
    AppResponsive(
    mobile: MobilePersonalScreen(),
    tablet: TabletPersonalScreen(),
    desktop: DesktopPersonalScreen()),
    EndWebSite()
    ],
    ),
    ),
  ...
  Container DesktopPersonalScreen() => Container(
    color: ColorManger.white,
    child: Column(
      children: [
        Container(
  ...
  Container TabletPersonalScreen() => Container(
    color: ColorManger.white,
    child: Column(
      children: [
        Container(
  ...
  Container MobilePersonalScreen() => Container(
    color: ColorManger.white,
    child: Column(
      children: [
        Container(
